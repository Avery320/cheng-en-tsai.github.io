...
<!-- 1. **造型**：
造型設計以結構為前提考量，為符合鋼筋混凝土的結構法規，設計在長寬 60 公分的平面與鋼筋籠段面為直徑 45 公分的條件之下做造型的變化。
1. **紋理**：
...
:::layout[50,50] 
![MultiScaleTruchetPattern_Rule](https://ik.imagekit.io/cheng3n/Graphcrete/MultiScaleTruchetPattern_02.jpg?updatedAt=1770897643741){border=true,radius=false}
@br()
![MultiScaleTruchetPattern](https://ik.imagekit.io/cheng3n/Graphcrete/MultiScaleTruchetPattern_01.jpg?updatedAt=1770897644550){border=true,radius=false}
@slot
...
:::grid
![](https://ik.imagekit.io/cheng3n/Graphcrete/3DCP_CONSTRUCTION1.png?updatedAt=1770897664873)
![](https://ik.imagekit.io/cheng3n/Graphcrete/3DCP_CONSTRUCTION2.png?updatedAt=1770897666085)
![](https://ik.imagekit.io/cheng3n/Graphcrete/3DCP_CONSTRUCTION3.png?updatedAt=1770897664444)
![](https://ik.imagekit.io/cheng3n/Graphcrete/3DCP_CONSTRUCTION4.png?updatedAt=1770897665425)
:::

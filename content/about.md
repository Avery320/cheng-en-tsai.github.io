...
相關開發內容包括 ROS、Web 介面開發、Grasshopper 參數化設計、BIM 相關應用、3D 可視化介面與、AI 輔助開發。
橫跨建築、參數化設計與機器人之間的幾何資料整合與應用

## Project:

### **[RoboSim](#ROBOT/RoboSim)**
**Human-computer interface | ROS | Robotics | Grasshopper**
@iframe[](https://avery320.github.io/robot-demo/javascript/example/bundle/main.html)

### **雙機械手臂協同鋼筋混凝土列印構建建造**
**Robotic Concrete Printing | Robotic Fabrication | Human-computer interface | ROS | Robotics**

### [Graphcrete](#PROJECT/Graphcrete)
**Robotic Concrete Printing | Robotic Fabrication | Grasshopper**
:::grid
![](https://ik.imagekit.io/cheng3n/Graphcrete/3DCP_CONSTRUCTION0.jpg?updatedAt=1770897640286)
...
:::grid
![Start Page](content/ROBOT/RoboSight/assets/robosight.PNG)
![Camera](content/ROBOT/RoboSight/assets/camera.PNG)
![Robot](content/ROBOT/RoboSight/assets/robot.PNG)
:::
...
![](https://ik.imagekit.io/cheng3n/%E5%BB%BA%E7%AF%89%E7%A0%94%E7%A9%B6%E6%89%80/srf02.JPG)
![](https://ik.imagekit.io/cheng3n/%E5%BB%BA%E7%AF%89%E7%A0%94%E7%A9%B6%E6%89%80/srf03.JPG)
:::

### [整合機械手臂與電腦視覺發展自組立低碳循環建材暨建構系統](#PROJECT/Robotic_Tectionics)
**Grasshopper | Robotics | ROS**
